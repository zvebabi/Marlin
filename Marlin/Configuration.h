...
#define MACHINE_UUID "50aaefd1-bac7-4914-9d73-a6a0ce46fbb1"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 11.58 }
    #define DEFAULT_Ki_LIST {  0.57 }
    #define DEFAULT_Kd_LIST { 58.48 }
  #else
    #define DEFAULT_Kp 11.58
    #define DEFAULT_Ki 0.57
    #define DEFAULT_Kd 58.48
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 72.13
  #define DEFAULT_bedKi 14.06
  #define DEFAULT_bedKd 246.72
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 441.24 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, -7, -2.47 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 31              // Set Mesh bounds as an inset region of the bed
